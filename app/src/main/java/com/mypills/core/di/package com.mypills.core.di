...
import com.mypills.core.database.AppDatabase
...
object RepositoryModule {
    ...
    fun provideMedicationRepository(
        ...
        return com.mypills.features.medications.data.repository.MedicationRepositoryImpl(medicationDao)
    }
